            ...
            <Grid>
                ...
                <div className="my-textToImage aspect-4/5 col-start-1 min-[500px]:col-start-5 min-[500px]:col-end-9 col-end-13">
                    <SlidingImage
                        ...
                        src={image2}
                        alt={
                            "A black and white 35mm photos of Liam smiling at the camera"
                        }
                    />
                </div>
                ...
                <section className="col-span-12 col-start-1 animate-fade-in opacity-0">
                    ...
                    <Text variant="content" className="mt-paragraph">
                        I&apos;m a husband, father, software engineer, and
                        curious tinkerer.
                    </Text>
                    <Text variant="content" className="mt-paragraph">
                        Born and raised in North Wales, I initially worked in
                        the TV industry in London after university, but soon
                        found my true passion in tech. Now based in Winchester,
                        England, I specialise in full-stack web development,
                        helping brands optimise their digital experiences and
                        deliver outstanding customer journeys.
                    </Text>
                    <Text variant="content" className="mt-paragraph">
                        I’m fortunate to work in a field where innovation drives
                        change, and I love that I get to use my skills to
                        enhance people's everyday online experiences and support
                        the scalability of great companies.
                    </Text>
                    <Text variant="content" className="mt-paragraph">
                        On this site, I share insights and learnings from my
                        journey in software engineering. From industry trends to
                        personal insights, I enjoy jotting down ideas that might
                        be valuable for others.
                    </Text>
                    <Text variant="content" className="mt-paragraph">
                        Outside of work, my favourite things are spending time
                        with my family, photography, and, on the very rare
                        occasion, exercise.
                    </Text>
                </section>
            </Grid>
